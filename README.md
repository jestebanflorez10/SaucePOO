...
Sauce es un proyecto de software en Java con interfaz grafica (gracias a la liberia Swing) para la gestión de pequeñas pizzerías. El software automatizará los procesos de pedidos, facturación e inventario de la pizzeria. Sauce contara con dos tipos de usuario: administradores y cajeros, quienes podrán gestionar eficientemente las operaciones diarias del negocio, optimizando la atención al cliente y reduciendo errores operativos en el punto de venta.
## ¿Cómo instalar Sauce?
